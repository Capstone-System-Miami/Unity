...
namespace SystemMiami.CombatSystem
{
    ...
    public class EnemyController : MonoBehaviour
    {
        ...
        //{
        //    // Movement Phase
        //    TurnManager.MGR.currentPhase = Phase.MovementPhase;
        //    TurnManager.MGR.BeginTurn?.Invoke(enemy);
        //    TurnManager.MGR.NewTurnPhase?.Invoke(Phase.MovementPhase);

        //    Debug.Log($"{enemy.name}'s Movement Phase.");
        //    yield return StartCoroutine(MovementPhase());

        //    // Action Phase
        //    TurnManager.MGR.currentPhase = Phase.ActionPhase;
        //    TurnManager.MGR.NewTurnPhase?.Invoke(Phase.ActionPhase);
